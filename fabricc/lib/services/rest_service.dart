...
class RestService {
  ...
  static const String baseUrl =
      'us-central1-companion-dc793.cloudfunctions.net/api';
  ...
  Future post(String endpoint, {dynamic data}) async {
    final response = await http.post(Uri.http(baseUrl, endpoint),
  ...
  Future patch(String endpoint, {dynamic data}) async {
    final response = await http.patch(Uri.http(baseUrl, endpoint),
        headers: {'Content-Type': 'application/json'}, body: jsonEncode(data));
